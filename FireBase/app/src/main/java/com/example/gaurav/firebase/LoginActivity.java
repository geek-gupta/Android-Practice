...
//            mAuthTask.execute((Void) null);
    ...
    void loginSuccessful(){
        Intent startActivtyIntent = new Intent(LoginActivity.this,MainActivity.class);
    ...
    void registerUser(final String email, final String password){
        firebaseAuth.createUserWithEmailAndPassword(email,password)
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    showProgress(false);
                    Toast.makeText(LoginActivity.this, "user Regsitered Enter username password to login", Toast.LENGTH_SHORT).show();
                    //loginSuccessful();
                }else {
                    showProgress(false);
                    Toast.makeText(LoginActivity.this, "Unable to login Button ", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            firebaseAuth.signInWithEmailAndPassword(mEmail,mPassword)
                    .addOnCompleteListener(LoginActivity.this,onCompleteListener);
